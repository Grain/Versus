...
void initializeStats()  //TODO: this D':
{
    //basic 1
    ...
    towerStats[1][0][0].homing = false;
    towerStats[1][0][0].range = 100;
    towerStats[1][0][0].speed = 4;
    towerStats[1][0][0].type = 4;

    //2.1 lvl 0
    towerStats[1][1][0].cost = 100;
    towerStats[1][1][0].damage = 10;
    towerStats[1][1][0].fireRate = 30;
    towerStats[1][1][0].homing = false;
    towerStats[1][1][0].range = 100;
    towerStats[1][1][0].speed = 4;
    towerStats[1][1][0].type = 5;

    //2.1 lvl 1
    towerStats[1][1][1].cost = 100;
    towerStats[1][1][1].damage = 10;
    towerStats[1][1][1].fireRate = 30;
    towerStats[1][1][1].homing = false;
    towerStats[1][1][1].range = 100;
    towerStats[1][1][1].speed = 4;
    towerStats[1][1][1].type = 5;

    //2.1 lvl 2
    towerStats[1][1][2].cost = 100;
    towerStats[1][1][2].damage = 10;
    towerStats[1][1][2].fireRate = 30;
    towerStats[1][1][2].homing = false;
    towerStats[1][1][2].range = 100;
    towerStats[1][1][2].speed = 4;
    towerStats[1][1][2].type = 5;

    //2.1 lvl 3
    towerStats[1][1][3].cost = 100;
    towerStats[1][1][3].damage = 10;
    towerStats[1][1][3].fireRate = 30;
    towerStats[1][1][3].homing = false;
    towerStats[1][1][3].range = 100;
    towerStats[1][1][3].speed = 4;
    towerStats[1][1][3].type = 5;

    //2.2 lvl 0
    towerStats[1][2][0].cost = 100;
    towerStats[1][2][0].damage = 10;
    towerStats[1][2][0].fireRate = 30;
    towerStats[1][2][0].homing = false;
    towerStats[1][2][0].range = 100;
    towerStats[1][2][0].speed = 4;
    towerStats[1][2][0].type = 6;

    //2.2 lvl 1
    towerStats[1][2][1].cost = 100;
    towerStats[1][2][1].damage = 10;
    towerStats[1][2][1].fireRate = 30;
    towerStats[1][2][1].homing = false;
    towerStats[1][2][1].range = 100;
    towerStats[1][2][1].speed = 4;
    towerStats[1][2][1].type = 6;

    //2.2 lvl 2
    towerStats[1][2][2].cost = 100;
    towerStats[1][2][2].damage = 10;
    towerStats[1][2][2].fireRate = 30;
    towerStats[1][2][2].homing = false;
    towerStats[1][2][2].range = 100;
    towerStats[1][2][2].speed = 4;
    towerStats[1][2][2].type = 6;

    //2.2 lvl 3
    towerStats[1][2][3].cost = 100;
    towerStats[1][2][3].damage = 10;
    towerStats[1][2][3].fireRate = 30;
    towerStats[1][2][3].homing = false;
    towerStats[1][2][3].range = 100;
    towerStats[1][2][3].speed = 4;
